...
function increase_cart_item_quantity_ajax() {
...
add_action('wp_ajax_increase_cart_item_quantity', 'increase_cart_item_quantity_ajax');
add_action('wp_ajax_nopriv_increase_cart_item_quantity', 'increase_cart_item_quantity_ajax');